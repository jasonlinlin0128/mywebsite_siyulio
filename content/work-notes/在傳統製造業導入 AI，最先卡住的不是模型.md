...
<div class="article-signal-hero">
  <div class="article-signal-hero__copy">
    <p class="article-signal-hero__eyebrow">Feature Story / AI Adoption in Manufacturing</p>
    <h2>真正卡住企業 AI 的，常常不是模型，而是「大家願不願意改變工作方式」。</h2>
    <p>
      如果要用一句話總結這篇文章，我會說：企業裡最早出現的阻力，通常不是技術不夠，而是流程慣性、驗證責任與學習成本。
    </p>
  </div>
  <div class="article-signal-hero__stats">
    <div class="article-signal-stat">
      <span>最常聽到</span>
...
<figure class="article-visual-frame">
  <img src="./ai-adoption-friction-map.svg" alt="企業 AI 導入阻力圖，顯示增加工作量感、流程慣性與沒有時間學三個核心阻力。" />
...
<div class="article-insight-grid">
  <div class="article-insight-card">
    <small>01</small>
    <h3>增加工作量感</h3>
    <p>如果同仁感覺用了 AI 之後只是多一道驗證程序，就不會真的想改。</p>
  </div>
  <div class="article-insight-card">
    <small>02</small>
    <h3>流程慣性</h3>
    <p>很多工作不是不能優化，而是原本那套做法已經熟到讓人不想動。</p>
  </div>
  <div class="article-insight-card">
    <small>03</small>
    <h3>時間成本</h3>
    <p>工作節奏已經很滿時，「再學一套新工具」本身就會被當成阻力。</p>
  </div>
</div>
...
<div class="article-task-strip">
  <div class="article-task-card">
    <span>低阻力任務</span>
    <strong>會議摘要</strong>
  </div>
  <div class="article-task-card">
...
<div class="article-takeaway-box">
  <p class="article-takeaway-box__label">Quick Takeaway</p>
  <p>
...
前一篇會把阻力拆得更細，後一篇則會開始進到我實際怎麼把 AI 變成工作方法。
